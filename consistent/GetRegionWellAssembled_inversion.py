...
def defineRegionFile(bamFile,dicoStats,chr,start,end,threshold_pval,readLength, bin,buffer,f,mult):
...
def main(param):
	...
	lstLstWrong=[]
		...
		###Analyse a bam file
		lstG,lstW=defineRegionFile(bam,dicoStats,param.chr,param.start,param.end,param.pvalMate,param.readLength,param.bin, param.buffer,param.frequency,param.mult)
...
parser.add_argument('--thrWrong', action='store', dest='thrWrong', help='coverage threshold to defin a wrong region [10]', default=10, type=int)
